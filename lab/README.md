> **Lab harness only.** This is the old Cloud Run rehearsal: no named volumes on
> `/paperclip`, empty database on recreate, **not** the Mac Mini install.
> Day-to-day deploy: [`../local/`](../local/).
